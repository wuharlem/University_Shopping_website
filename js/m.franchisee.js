    ...
    $.ajax({
        ...
        success: function(response) {
           ...
           result= response.result;
            ...
            if(result.length>0){
                for(var i=0;i<result.length;i++){
                table += '<tr><th><div>品牌</div></th><td><div>'+result[i].Brand+'</div></td></tr><tr><th><div>手机号码</div></th><td><div>'+result[i].Phone+'</div></td></tr><tr><th><div>注册日</div></th><td><div>'+result[i].RegisteredDate+'</div></td></tr><tr><th><div>受邀日</div></th><td><div>'+result[i].SN2Date+'</div></td></tr><tr><th><div>首次消费日</div></th><td><div>'+result[i].SN4MinUsedDate+'</div></td></tr><tr><th><div>最新消费日</div></th><td><div>'+result[i].SN4Date+'</div></td></tr><tr><th><div>到期日</div></th><td><div>'+result[i].MaturityDate+'</div></td></tr><tr><th><div>近十天上线率</div></th><td><div>'+result[i].UsedDays+'</div></td></tr><tr><th><div>连续未上线</div></th><td><div>'+result[i].UsedMaxTime+'日</div></td></tr><tr><th><div>总消費額</div></th><td><div>'+result[i].Phone+''+result[i].TotalConsume+'</div></td></tr><tr><th><div>本期消费额</div></th><td><div>'+result[i].WeekConsume+'</div></td></tr><tr><th><div>分润奖金</div></th><td><div>'+result[i].WeekCommission+'</div></td></tr>';
            }
            }
